...
<form action="/consulta5" method="post">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputFecha1">Fecha 1</label>
      <input type="date" class="form-control" name="fecha1" id="inputFecha1" placeholder="Ingresar Fecha 1" required>
    </div>
<div class="container mt-5">
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputFecha1">Fecha 2</label>
      <input type="date" class="form-control" name="fecha2" id="inputFecha2" placeholder="Ingresar Fecha 2" required>
    </div>
</div>
